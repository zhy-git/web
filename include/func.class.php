...
function GetContPage($content)
{
	...
	if(strpos($content, $nextpage))
	{
		...
		if($page > 1)
		{
			...
			{
				$page_content .= $cfg_mobile=='Y'?'<a href="'.$nowurl.'page=1">&lt;&lt;</a>':'<a href="'.$nowurl.'-1.html">&lt;&lt;</a>';
				$page_content .= $cfg_mobile=='Y'?'<a href="'.$nowurl.'page='.$previous.'">&lt;</a>':'<a href="'.$nowurl.'-'.$previous.'.html">&lt;</a>';
			}
		}
		else
		{
		...
		for($i=1; $i<=$totalpage; $i++)
		{
			...
			else
			{
				...
				if($cfg_isreurl != 'Y')
					...
					$page_content .= $cfg_mobile=='Y'?'<a href="'.$nowurl.'page='.$i.'" class="num">'.$i.'</a>':'<a href="'.$nowurl.'-'.$i.'.html" class="num">'.$i.'</a>';
			}
		}
		...
		if($page < $totalpage)
		{
			...
			{
				$page_content .= $cfg_mobile=='Y'?'<a href="'.$nowurl.'page='.$next.'">&gt;</a>':'<a href="'.$nowurl.'-'.$next.'.html">&gt;</a>';
				$page_content .= $cfg_mobile=='Y'?'<a href="'.$nowurl.'page='.$totalpage.'">&gt;&gt;</a>':'<a href="'.$nowurl.'-'.$totalpage.'.html">&gt;&gt;</a>';
			}
		}
		else
		{
